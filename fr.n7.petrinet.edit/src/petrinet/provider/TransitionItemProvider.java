		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transition_arc_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transition_arc_feature", "_UI_Transition_type"),
				 PetrinetPackage.Literals.TRANSITION__ARC,
				 true,
				 false,
				 true,
				 null,
